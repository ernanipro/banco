...
public class TelaMovimento implements Tela {
	...
	private void incluirMovimento() {
		...
		TipoMovimento tipoMovimento = TipoMovimento.valueOf(movimentoDesejado.toUpperCase());
		...
		// 3 - adicionar o movimento a conta do correntista selecionado
		try {
